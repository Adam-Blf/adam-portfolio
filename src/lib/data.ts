...
export const logoMap: Record<string, string> = {
  ...
  "College Liberte": "/logos/college_liberte_logo.jpg",
...
export const personalInfo = {
  ...
  subtitle: "M1 Mastère Data Engineering & IA · EFREI · Ingénieur PMSI / Data Engineer · GHT Psy Sud Paris",
  ...
  languages: ["Français (Natif)", "Anglais (C1 · Professionnel)", "Espagnol (C1 · Professionnel)"],
  highlights: [
    "Architecture Data & Pipelines ETL/ELT (Architecture Médaillon)",
    "Machine Learning, NLP & IA Générative (RAG, LLM Fine-Tuning)",
    "Fullstack TypeScript/Next.js + Python/FastAPI",
    "Leadership · Vice-Président BDE ISIT 700 étudiants 2 mandats",
  ],
  currentRole: {
    title: "Ingénieur PMSI / Data Engineer",
    company: "Fondation Vallée · GHT Sud Paris (DIM Pédopsychiatrie)",
    type: "Alternance M1 · sept. 2025 → sept. 2026",
  },
  bio: `Passionné par la data et l'innovation, je construis des systèmes intelligents qui transforment les données en décisions stratégiques. Mon parcours combine expertise technique (Data Engineering, IA générative, Fullstack TypeScript) et leadership terrain (Vice-Président BDE ISIT 2 mandats consécutifs sur 700 étudiants 40 nationalités, Préparation Militaire Marine Kieffer). Actuellement en M1 Mastère Data Engineering & IA à l'EFREI Paris (RNCP 40875), j'industrialise des solutions data pour le secteur hospitalier au DIM du GHT Sud Paris.`,
}
...
export const education = [
  {
    ...
    current: false,
    description: "Diplome National du Brevet obtenu au College Liberte de Chevilly-Larue avec la Mention Tres Bien. Cycle complet de la 6eme a la 3eme. Option Latin.",
    highlights: [
      "Mention Tres Bien",
      "Option Latin",
      "Chevilly-Larue",
  ...
  },
  {
    ...
    current: false,
    description: "Baccalaureat general au Lycee Saint-Joseph de Villejuif. Tronc commun + 3 specialites en Premiere (Mathematiques, Physique-Chimie, SVT) puis 2 en Terminale (Mathematiques, SVT). Epreuves anticipees de Francais en Premiere, Grand Oral en Terminale. Obtenu avec Mention Assez Bien.",
    highlights: [
      "Mention Assez Bien",
    ...
    skills: [
      ...
      "SVT (specialite)",
      "Physique-Chimie (specialite Premiere)",
      "Francais (epreuves anticipees)",
      "Philosophie",
      "Histoire-Geographie",
  ...
  },
  {
    ...
    level: "Mention Assez Bien",
    current: false,
    description: "Formation militaire de 12 mois au sein de la Marine Nationale (PMM Kieffer, Villeneuve-Saint-Georges). Stage pratique et theorique : formation militaire et maritime sur 12 week-ends + 1 semaine bloquee en port militaire. Maniement des armes (FAMAS), ordre serre, matelotage, lutte incendie, PSC1, permis bateau cotier. Participation aux ceremonies officielles (11 Novembre, 8 Mai). Diplome obtenu avec Mention Assez Bien.",
    highlights: [
      "Diplome PMM Mention Assez Bien",
      "Permis bateau cotier",
      "PSC1 (Premiers Secours)",
      "Semaine bloquee en port militaire",
      "Tir au FAMAS",
      "Ceremonies officielles (11 Nov, 8 Mai)",
    ],
    skills: [
      "Formation militaire (ordre serre, reglement)",
      "Maniement des armes (FAMAS)",
      "Matelotage (noeuds marins, manoeuvres)",
      "Lutte incendie",
      "PSC1 (Premiers Secours Civiques)",
      "Permis bateau cotier",
      "Hebertisme (parcours sportif)",
      "Ceremonies et protocole militaire",
      "Leadership & esprit d'equipage",
      "Travail d'equipe & cohesion",
      "Gestion du stress",
      "Rigueur & Discipline",
    ],
    debouches: [],
...
export const formationCourses = {
  ...
  pmm: {
    ...
    school: "Marine Nationale, Villeneuve-Saint-Georges",
    period: "2020 - 2021",
    rncp: null,
    rncpTitle: null,
    years: {
      "Week-ends de formation (12 seances)": [
        { name: "Ordre serre (defilé, rassemblement, salut)", category: "militaire" },
        { name: "Reglement militaire & grades de la Marine", category: "militaire" },
        { name: "Matelotage (noeuds marins, manoeuvres)", category: "militaire" },
        { name: "Transmissions & communication radio", category: "militaire" },
        { name: "Navigation & lecture de carte marine", category: "militaire" },
        { name: "Hebertisme (parcours sportif d'obstacles)", category: "militaire" },
        { name: "Condition physique & sport collectif", category: "militaire" },
        { name: "Esprit d'equipage & cohesion", category: "militaire" },
      ],
      "Semaine bloquee en port militaire": [
        { name: "Tir au FAMAS (fusil d'assaut)", category: "militaire" },
        { name: "Lutte incendie & securite", category: "militaire" },
        { name: "Visite de batiments de guerre", category: "militaire" },
        { name: "Embarquement a la mer", category: "militaire" },
        { name: "Visite des installations de la base navale", category: "militaire" },
        { name: "Permis bateau cotier (formation + examen)", category: "militaire" },
      ],
      "Formations certifiantes": [
        { name: "PSC1 - Premiers Secours Civiques niveau 1", category: "militaire" },
        { name: "Permis bateau plaisance option cotiere", category: "militaire" },
      ],
      "Ceremonies officielles": [
        { name: "Ceremonie du 11 Novembre", category: "militaire" },
        { name: "Ceremonie du 8 Mai", category: "militaire" },
        { name: "Prise d'armes & remise de diplomes", category: "militaire" },
      ],
    },
  },
  lycee: {
    title: "Baccalaureat General - Mention Assez Bien",
    school: "Lycee Saint-Joseph, Villejuif",
    period: "2019 - 2022",
    rncp: null,
    rncpTitle: null,
    years: {
      "Seconde generale (2019-2020)": [
        ...
        { name: "Enseignement Moral et Civique (EMC)", category: "general" },
        { name: "Anglais (LV1)", category: "international" },
        { name: "Espagnol (LV2)", category: "international" },
        { name: "Sciences Economiques et Sociales (SES)", category: "general" },
        { name: "Sciences Numeriques et Technologie (SNT)", category: "tech" },
      ...
      "Premiere - Spe Maths/Physique/SVT (2020-2021)": [
        ...
        { name: "Francais - epreuves anticipees (ecrit + oral)", category: "communication" },
        { name: "Histoire-Geographie", category: "general" },
        { name: "Enseignement Scientifique", category: "sciences" },
        { name: "Enseignement Moral et Civique (EMC)", category: "general" },
        { name: "Anglais (LV1)", category: "international" },
        { name: "Espagnol (LV2)", category: "international" },
        { name: "EPS", category: "general" },
  ...
  college: {
    ...
    rncpTitle: null,
    years: {
      "Cycle 3 - 6eme (2015-2016)": [
        { name: "Mathematiques", category: "sciences" },
        { name: "Francais", category: "communication" },
        { name: "Histoire-Geographie-EMC", category: "general" },
        { name: "Sciences et Technologie", category: "sciences" },
        { name: "Anglais (LV1)", category: "international" },
        { name: "Arts Plastiques", category: "design" },
        { name: "Education Musicale", category: "general" },
        { name: "EPS", category: "general" },
        { name: "Latin (option)", category: "international" },
      ],
      "Cycle 4 - 5eme (2016-2017)": [
        { name: "Mathematiques", category: "sciences" },
        { name: "Francais", category: "communication" },
        { name: "Histoire-Geographie-EMC", category: "general" },
        { name: "Physique-Chimie", category: "sciences" },
        { name: "SVT", category: "sciences" },
        { name: "Technologie", category: "tech" },
        { name: "Anglais (LV1)", category: "international" },
        { name: "Espagnol (LV2)", category: "international" },
        { name: "Latin (option)", category: "international" },
        { name: "Arts Plastiques", category: "design" },
      ...
      "Cycle 4 - 3eme + Brevet (2018-2019)": [
        { name: "Mathematiques (epreuve Brevet)", category: "sciences" },
        { name: "Francais (epreuve Brevet)", category: "communication" },
        { name: "Histoire-Geographie-EMC (epreuve Brevet)", category: "general" },
        { name: "Physique-Chimie", category: "sciences" },
        { name: "SVT", category: "sciences" },
        { name: "Technologie", category: "tech" },
        { name: "Anglais (LV1)", category: "international" },
        ...
        { name: "Education Musicale", category: "general" },
        { name: "EPS", category: "general" },
        { name: "Oral du Brevet (soutenance de projet)", category: "communication" },
        { name: "Stage d'observation en entreprise (3eme)", category: "projet" },
      ],
    },
  },
}
